...
Source/2_App/BswCom/%.src: ../Source/2_App/BswCom/%.c Source/2_App/BswCom/subdir.mk
	...
	cctc -D_TASKING_C_TRICORE_ "-fD:/OTA_Traning/OTA_APP_3/Training/TASKING_C_C___Compiler-Include_paths.opt" --iso=99 --c++14 --language=+volatile --exceptions --anachronisms --fp-model=3 -O0 --tradeoff=4 --compact-max-size=200 -g -Wc-w544 -Wc-w557 -Ctc23x -o "$@"  "$<"  -cs --misrac-version=2012 -N0 -Z0 -Y0 2>&1;
