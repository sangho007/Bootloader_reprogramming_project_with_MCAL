...
#ifdef FeeConf_FeeBlockConfiguration_ReprogrammingSuccesstCounter 
/* to prevent double declaration */
#error FeeConf_FeeBlockConfiguration_ReprogrammingSuccesstCounter already defined
#else 
#define FeeConf_FeeBlockConfiguration_ReprogrammingSuccesstCounter ((uint16)12)
#endif /* #ifdef FeeConf_FeeBlockConfiguration_ReprogrammingSuccesstCounter */
