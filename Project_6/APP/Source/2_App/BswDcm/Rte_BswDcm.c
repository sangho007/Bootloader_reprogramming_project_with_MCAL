...
static uint8 writeDataByIdentifier(void)
{
	...
	uint8 attemptCounter[DATA_LEN_AttemptCounter] = {0,};
	uint8 successCounter[DATA_LEN_SuccessCounter] = {0,};
	...
	else if(dataIdentifier == DID_VariantCode)
	{
	...
	else if(dataIdentifier == DID_AttemptCounter){
        ...
        {
            attemptCounter[0] = stBswDcmData.diagDataBufferRx[3];
            attemptCounter[1] = stBswDcmData.diagDataBufferRx[4];
            Rte_Call_BswDcm_rEcuAbsNvm_writeNvmData(DATA_ID_AttemptCounter, attemptCounter);
            stBswDcmData.diagDataLengthTx = 3u;
            stBswDcmData.diagDataBufferTx[0] = (FRAME_TYPE_SINGLE << 4u) | stBswDcmData.diagDataLengthTx;
            stBswDcmData.diagDataBufferTx[1] = SID_WriteDataByIdentifier + 0x40u;
            stBswDcmData.diagDataBufferTx[2] = (uint8)((dataIdentifier & 0xFF00) >> 8u);
	...
	else if(dataIdentifier == DID_SuccessCounter){
	    if(stBswDcmData.diagDataLengthRx != 5u)
        {
            errorResult = NRC_IncorrectMessageLengthOrInvalidFormat;
        }
        ...
        {
            successCounter[0] = stBswDcmData.diagDataBufferRx[3];
            successCounter[1] = stBswDcmData.diagDataBufferRx[4];
            Rte_Call_BswDcm_rEcuAbsNvm_writeNvmData(DATA_ID_SuccessCounter, successCounter);
            stBswDcmData.diagDataLengthTx = 3u;
            stBswDcmData.diagDataBufferTx[0] = (FRAME_TYPE_SINGLE << 4u) | stBswDcmData.diagDataLengthTx;
            stBswDcmData.diagDataBufferTx[1] = SID_WriteDataByIdentifier + 0x40u;
            stBswDcmData.diagDataBufferTx[2] = (uint8)((dataIdentifier & 0xFF00) >> 8u);
...
static uint8 readDataByIdentifier(void)
{
    ...
    {
        Rte_Call_BswDcm_rEcuAbsNvm_readNvmData(DATA_ID_AttemptCounter, attemptCounter);
        stBswDcmData.diagDataLengthTx = 5u;
        stBswDcmData.diagDataBufferTx[0] = (FRAME_TYPE_SINGLE << 4u) | stBswDcmData.diagDataLengthTx;
        stBswDcmData.diagDataBufferTx[1] = SID_ReadDataByIdentifier + 0x40u;
        stBswDcmData.diagDataBufferTx[2] = (uint8)((dataIdentifier & 0xFF00) >> 8u);
        stBswDcmData.diagDataBufferTx[3] = (uint8)(dataIdentifier & 0xFFu);
        stBswDcmData.diagDataBufferTx[4] = attemptCounter[0];
        stBswDcmData.diagDataBufferTx[5] = attemptCounter[1];
    }
	else if(dataIdentifier == DID_SuccessCounter)
    {
        ...
        stBswDcmData.diagDataBufferTx[2] = (uint8)((dataIdentifier & 0xFF00) >> 8u);
        stBswDcmData.diagDataBufferTx[3] = (uint8)(dataIdentifier & 0xFFu);
        stBswDcmData.diagDataBufferTx[4] = successCounter[0];
        stBswDcmData.diagDataBufferTx[5] = successCounter[1];
    }
	else
	{
		errorResult = NRC_RequestOutRange;
